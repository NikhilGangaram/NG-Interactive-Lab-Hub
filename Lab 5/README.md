...
1. TTS model prompts the user to sign a gesture.
1. The user signs the gesture, which is then sent to MoonDream.
1. MoonDream classifies the gesture and returns feedback to the user.
1. TTS model reads the feedback and speaks it back to the user.
1. This could then be turned into an iterative loop, which repeats 

Here is an image of the prototype flow: 

![Prototype Flow](assets/images/prototype_flow.png "Prototype Flow")
